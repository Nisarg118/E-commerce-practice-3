...
//@desc Retrieve the products based on ratings
//@access Public
...
router.get("/best-seller", async (req, res) => {
  try {
    ...
    console.log("Error in best seller product", error);
    return res.status(500).json({ message: "Internal server error" });
  }
});
...
router.get("/new-arrivals", async (req, res) => {
  try {
    ...
    console.log("Error in new arrivals product", error);
    return res.status(500).json({ message: "Internal server error" });
  }
});
...
router.get("/similar/:id", async (req, res) => {
  ...
  try {
    ...
    console.log("Error in similar product", error);
    return res.status(500).json({ message: "Internal server error" });
  }
});
